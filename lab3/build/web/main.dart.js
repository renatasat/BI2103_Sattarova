...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Инкремент", theme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.pink, useMaterial3: true, brightness: ui.Brightness.light}), darkTheme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.blue, useMaterial3: true, brightness: ui.Brightness.dark}), home: C[1] || CT.C1, debugShowCheckedModeBanner: false});
    }
  };
  ...
  var _removeButton = dart.privateName(main, "_removeButton");
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({backgroundColor: theme.Theme.of(context).colorScheme.inversePrimary, title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([C[2] || CT.C2, new text.Text.new(dart.str(this[_counter]), {style: theme.Theme.of(context).textTheme.headlineMedium}), C[3] || CT.C3, new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _decrementCounter), tooltip: "Decrement", child: C[4] || CT.C4, backgroundColor: colors.Colors.red}), new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _incrementCounter), tooltip: "Increment", child: C[6] || CT.C6, backgroundColor: colors.Colors.pink})])}), C[3] || CT.C3, new text_button.TextButton.new({onPressed: dart.bind(this, _removeButton), child: C[8] || CT.C8})])})})});
    }
  ...
  dart.setMethodSignature(main._MyHomePageState, () => ({
    ...
    [_removeButton]: dart.fnType(dart.void, []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC5C4B;AACxB,YAAO,iCACE,oBACA,2CACmB,kCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QApBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IA0BX;;;;;;;;;;;;AAGsB;IAAkB;;;QAL7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAc9C,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAII,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAII,MAFF,cAAS;AACG,QAAV,iBAAS;;IAEb;UAG0B;AAExB,YAAO,oCACG,yCACiB,AAAY,AAAY,eAArB,OAAO,qCAC1B,kBAAK,AAAO,4BAEf,6BAEG,yCAEgC,yCACnB,uCAIhB,kBACa,SAAT,yBACW,AAAY,AAAU,eAAnB,OAAO,6CAGzB,sCACuC,yCACnB,wBAChB,0EACa,mCACF,oDAEe,qBAE5B,0EACa,mCACF,oDAEe,yCAK5B,qDACa;IAOvB;;;;;;IAlEI,iBAAW;;;EAmEjB;;;;;;;;;;;;;;;;AAxGuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
